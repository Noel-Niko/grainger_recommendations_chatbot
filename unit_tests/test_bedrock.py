...
class TestBedrockClientManager(unittest.TestCase):
    ...
    def should_refresh_credentials(self):
        ...
        mock_credentials = {"AccessKeyId": "fake_access_key_id", "SecretAccessKey": "fake_secret_access_key", "SessionToken": "fake_session_token"}
        with patch.object(manager, "assume_role_and_get_credentials", return_value=mock_credentials), patch.object(
            manager, "update_client_kwargs_with_credentials"
        ) as mock_update:
