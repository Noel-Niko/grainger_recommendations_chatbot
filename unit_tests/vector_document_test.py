...
# Mocking function, this should be defined inside your test class if it's used only there
def create_vector_store(mock_faiss_class, mock_embed_documents, mock_pickle_load, mock_open, mock_read_parquet,
                        mock_path_exists):
    # Arrange
...
class TestInitializeEmbeddingsAndFaiss(unittest.TestCase):
    ...
    def test_initialize_embeddings_and_faiss(self, mock_faiss_class, mock_embed_documents, mock_pickle_load, mock_open,
        ...
        # Arrange
        vector_store_impl = create_vector_store(mock_faiss_class, mock_embed_documents, mock_pickle_load, mock_open,
                                                mock_read_parquet, mock_path_exists)
