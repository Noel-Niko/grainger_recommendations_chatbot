...
from legacy.call_for_single_product_review_selenium import navigate_to_reviews_selenium  # Import your function from call_for_single_product_review_selenium.py
